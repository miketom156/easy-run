...
public class ComReceive implements Serializable {
	...
	private String mark; 			// 不符合,符合,待定,已面试,待邀请,已邀请,自定义标签CommonEnum.ComReceiveMark
	...
	/**
	 * 企业获得简历的来源 （0=个人主动应聘，1=后台推荐，2=企业主动邀请，3=视频面试）
	 * 参见:Constants.COM_CATCH_RESUME_FROM_PERSON
	 */
	private Integer receiveType;
	/**
	 * 发送通知信标志[1.视频面试通知 2.到场馆面试通知 3.到办公室面试通知 4.侍考虑 5.婉拒 6.自动回复]
	 */
