...
/**
 * Created by Andy on 2014/9/16. 职位与简历统计实体
 */
@Entity
@DynamicUpdate
@DynamicInsert
...
public class CountPosResCate implements Serializable {
    ...
    private Integer posApplyCount; // 简历投递量
    ...
    public Integer getPosApplyCount() {
        return posApplyCount;
    }

    public void setPosApplyCount(Integer posApplyCount) {
        this.posApplyCount = posApplyCount;
    }
}
