...
public class PosRecommendByEaseyeApi extends BaseMailSend{
    private static Logger logger = Logger.getLogger(PosRecommendByEaseyeApi.class);
    ...
    public PosRecommendByEaseyeApi() throws EmailServerConfigException {
        gson = new Gson();
        sender = new EmailSender(MailServer.THIRD_EASEYE);
    }

    public PosRecommendByEaseyeApi(MailServer mailServer) throws EmailServerConfigException {
        gson = new Gson();
    ...
    public static void main(String[] args) {
        try {
            ...
            PosRecommendByEaseyeApi recommend = new PosRecommendByEaseyeApi();
            recommend.setTestMailAddr("yf_198407@163.com");
            recommend.setSendLimitNum(2);
            recommend.send();
        ...
        if (allRecord > 0 ) {
            ...
            try {
                for (int i = 0; i < allPage; i++) {
                    ...
                    this.sendMail(logId, userList, statusMap);
                    session.clear();
                }
     ...
     * @throws IOException
     */
    private void sendMail(int logId, List<PerUser> userList, Map<String, Integer> statusMap) throws IOException {
