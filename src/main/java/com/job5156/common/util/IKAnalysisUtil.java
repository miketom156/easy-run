...
public class IKAnalysisUtil {
	...
	public static List<String> analysisKeywordSeg(String keyword) {
		return analysisKeywordSeg(keyword, FilterMode.DEFAULT, false);
	}
	 ...
	 * @return
	 */
	public static List<String> analysisKeywordSegAndSelf(String keyword){
		List<String> keywordList = analysisKeywordSeg(keyword, FilterMode.DEFAULT, false);
	 ...
	 * @return
	 */
	public static List<String> analysisKeywordSeg(String keyword, Integer modelVal, boolean isMaxWordLength){
		return analysisKeywordSeg(keyword, FilterMode.getInstance(modelVal), isMaxWordLength);
	}
	 ...
	 * @return
	 */
	public static List<String> analysisKeywordSeg(String keyword, FilterMode filterMode, boolean isMaxWordLength) {
		List<String> keywordList = Lists.newArrayList();
		if (StringUtils.isNotBlank(keyword)) {
			try {
				IKSegmentation ikSeg = new IKSegmentation(new StringReader(keyword), isMaxWordLength);
				Lexeme lex = null;
				while((lex = ikSeg.next()) != null){  
					String keywordSeg = lex.getLexemeText();
					if (filterKeywordSeg(filterMode, keywordSeg)) {
	...
	public static void main(String[] args) throws IOException{
		List<String> list = analysisKeywordSeg("java软件工程师", FilterMode.DEFAULT, true);
