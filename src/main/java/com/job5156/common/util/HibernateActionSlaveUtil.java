...
/**
 * <p>5156action从库连接池配置</p>
 *
 * Date:2015-5-14 下午5:27:43
 * @author leo
 * @version 1.0
 */
public class HibernateActionSlaveUtil{
	...
	static {
		try {
			...
			URL configFileURL = HibernateActionSlaveUtil.class.getResource("/hibernate-action-slave.cfg.xml");
