...
/**
 * <p>备份本地数据的hibernate连接工具类</p>
 *
 * Date:2015-5-14 上午8:58:55
 * @author leo
 * @version 1.0
 */
public class HibernateBackupActionUtil{
	...
	static {
		try {
			...
			URL configFileURL = HibernateBackupActionUtil.class.getResource("/hibernate-backup-action.cfg.xml");
