...
public class PerResume implements Serializable{
    ...
    public Map<String,Object> getMap() {
        ...
        PerResumeVo resumeVo = new PerResumeVo(this);

        if(CollectionUtils.isNotEmpty(resumeVo.getEducationInfoVoList())) {
            int highDegree = 0;
            for (PerEducationInfoVo infoVo : resumeVo.getEducationInfoVoList()) {
        ...
        PerIntentVo intentVo = resumeVo.getIntentInfoVo();
        if(intentVo != null){
            ...
            if(intentVo.getSalary() != null) {
                String salaryStr = OptionMap.getValue(OptionMap.OptionType.OPT_PER_NOWSALARY, intentVo.getSalary());
            ...
            if(CollectionUtils.isNotEmpty(resumeVo.getWorkInfoVoList())) {
                ...
                for (PerWorkInfoVo infoVo : resumeVo.getWorkInfoVoList()) {
