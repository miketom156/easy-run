...
public class RunUpdatePerActivity {
    private static Logger LOG = Logger.getLogger(RunUpdatePerActivity.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            new PerBehavAnalyse().updatePerActivity(fromDate, toDate);
        } catch (Exception e) {
