package com.job5156.common.option;
...
import com.job5156.common.CommonEnum.AreaType;
...
public class OptionMap {
    ...
    private final static Map<Integer, Map<String, String>> OPT_MAP_POS_DEGREE = new LinkedHashMap<>();
    ...
    static {
        ...
        ALLKEYMAP.put(OptionType.OPT_POS_DEGREE, OPT_MAP_POS_DEGREE);
        ...
        OPT_MAP_JOBTYPE.put(0, setMap("全职",  "Full-time","f-time")); //老数据中为0的视为全职
        ...
        // 学历-职位
        OPT_MAP_POS_DEGREE.put(1, setMap("初中及以下", "Junior High","junior"));
        OPT_MAP_POS_DEGREE.put(2, setMap("高中", "Senior High","seniro"));
        OPT_MAP_POS_DEGREE.put(3, setMap("中专", "Technical School","technical"));
        OPT_MAP_POS_DEGREE.put(4, setMap("大专", "College","college"));
        OPT_MAP_POS_DEGREE.put(5, setMap("本科", "Bachelor","bachelor"));
        OPT_MAP_POS_DEGREE.put(6, setMap("硕士及以上", "Master","master"));
        ...
        OPT_MAP_COM_PROPERTY.put(12, setMap("外资企业", "Foreign Enterprise","foreign")); //老数据处理
        OPT_MAP_COM_PROPERTY.put(13, setMap("外资企业", "Foreign Enterprise","foreign")); //老数据处理
        OPT_MAP_COM_PROPERTY.put(14, setMap("外资企业", "Foreign Enterprise","foreign")); //老数据处理
    ...
    public static Integer[] getJobTypeArr(Integer jobType) {
        ...
        if (jobType==0) { //老数据中 ‘不限’转换为 ‘全职’，新版数据中必须填写
            jobTypeArr = new Integer[]{1};
        }else    if (jobType == 4) { // 全|兼职
            jobTypeArr = new Integer[]{1, 2};
        } else  if (jobType == 5) {   //兼职+实习
            jobTypeArr = new Integer[]{2, 3};
        } else  if (jobType == 6) {   //全+实习   智聘新增
            jobTypeArr = new Integer[]{1, 3};
        }else  if (jobType == -1) {   //全+实习   智聘新增
     ...
     * 单项-->多项数组 String格式
     */
    public static String getJobTypeArrStr(Integer jobType) {
       Integer[] jobTypeArr=getJobTypeArr(jobType);
       String jobTypeArrStr="";
       for (Integer type:jobTypeArr){
           jobTypeArrStr+=(type+",");
       }
       if(jobTypeArrStr.endsWith(",")){
           jobTypeArrStr=jobTypeArrStr.substring(0,jobTypeArrStr.length()-1);
       }
        return jobTypeArrStr;
    }
