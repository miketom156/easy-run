...
import com.job5156.vo.BaiDuAddressComponentVo;
...
public class BaiDuApiUtil {
     ...
     * @return
     */
    public static BaiDuAddressComponentVo getAddCompVoByGPS(Double lat, Double lng) {
        ...
        if (addInfoJSON != null && !StringUtils.equals("", addInfoJSON)) {
            ...
            try {
                ...
                BaiDuAddressComponentVo addressComponentVo = gson.fromJson(jo.getJSONObject("result").getJSONObject("addressComponent").toString(), BaiDuAddressComponentVo.class);
...
//    			logger.error(e.getMessage(), e);
    ...
    public static String getCityThroughBaiduByGPS(Double lat, Double lng) {
        BaiDuAddressComponentVo addressComponentVo = getAddCompVoByGPS(lat, lng);
