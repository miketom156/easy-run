...
public class PerResumeCheckComponent {
...
//        PerUser perUser = perResume.getPerUser();
     ...
     * @return
     */
    /*public String cardCompleteMsg(PerResume perResume) throws InvocationTargetException, IllegalAccessException {
        ...
        PerResumeVo perResumeVo = new PerResumeVo(perResume);
        if (perResumeVo.getIntentInfoVo()!=null){
            PerResumeVo.IntentInfoVo intentInfoVo = perResumeVo.getIntentInfoVo();
        ...
        if(CollectionUtils.isNotEmpty(perResumeVo.getWorkInfoVoList())){
            CollectionSort.sortTheList(perResumeVo.getWorkInfoVoList(),"id","Asc");
            PerResumeVo.WorkInfoVo workInfoVo = perResumeVo.getWorkInfoVoList().get(0);
